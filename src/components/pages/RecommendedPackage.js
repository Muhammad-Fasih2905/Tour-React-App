...
const RecommendedPackage = () => {
  ...
  // const getPackages = async (selectedRegion) => {
  //   setLoader(true);

  //   let q;

  //   if (selectedRegion === "south") {
  //     q = query(collection(db, "packages"), where("region", "==", "south"));
  //   } else if (selectedRegion === "north") {
  //     q = query(collection(db, "packages"), where("region", "==", "north"));
  //   } else {
  ...
  console.log("Packages====>", localStorage.getItem("package"));

  console.log("Region====>", selectedRegion);
  console.log("Packages====>", packages);

  // getting response of question 1 start
  ...
  console.log("getQues====>", saveRegion);
  // getting response of question 1 end
      ...
      {loader ? (
        ...
        <>
          ...
          <div className="products">
            <h1 className="display-1">Recommended</h1>
          </div>
            ...
            <Container>
              ...
              <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                {packages
                  ...
                  .filter((e) => e.avg_rating > 0)
                  .filter((e) => e.region === saveRegion)
                  .map((e, i) => {
                    return (
                        ...
                        >
                          ...
                          <Card.Body>
                            ...
                            <small className="d-flex justify-content-end ps-1">
                              Rating:{" "}
                              {e.avg_rating > 5 ? 5 : Math.floor(e.avg_rating)}
                              /5
                            </small>
                          </Card.Body>
                        </div>
